...
const okay = befund.canvas && befund.name === 'WireProbe' && befund.bestenliste.length > 40 && echte.length === 0;
...
console.log(JSON.stringify({ okay, befund, fehler: gebuendelt }, null, 1));
