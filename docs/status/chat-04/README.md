...
| --- | --- | --- | --- | --- | --- |
| [13](./13-deploy-wache-projektiltempo.md) | Deploy-Wache mit drei Fällen, Projektiltempo gepaart gemessen | `claude/chat-04-infra-betrieb-ihx0xz` | `PLATZ13` | 707 ✔ | **offen** |
